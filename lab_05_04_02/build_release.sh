...
gcc -std=c99 -Wall -Werror -Wextra -Wpedantic -Wfloat-equal -Wfloat-conversion -Wvla -O3 -c case.c
gcc -o app.exe main.o print_file.o sort_file.o add_to_file.o case.o
